...
const awards = [
  {
    ...
    requirements: {
      ...
      description: "Develop a cost-efficient method to garble more than 1KB of data while maintaining data integrity and security.",
      bulletPoints: [
  ...
  },
  {
    ...
    requirements: {
      ...
      description: "Create a comprehensive tutorial explaining how to send a private transaction on COTI using Bolt.new.",
      bulletPoints: [
  ...
  {
    amount: "$250",
    blocker: "Example repo on paying COTI when knowledge is added to a fine-tuning script",
    requirements: {
      title: "COTI Payment Integration for Fine-Tuning",
      description: "Develop a sample repository demonstrating how to integrate COTI payments when new knowledge is added to an AI fine-tuning script.",
      bulletPoints: [
  ...
  },
  {
    ...
    requirements: {
      ...
      description: "Create a comprehensive strategy to introduce the COTI Ambassador program to Michael Polson.",
      bulletPoints: [
  ...
  },
  {
    ...
    requirements: {
      ...
      description: "Design a visually appealing and informative CMYK poster for a COTI create-a-thon event in Tokyo.",
      bulletPoints: [
  ...
  },
  {
    ...
    requirements: {
      ...
      description: "Locate and secure a suitable venue in Denver for 100 people with a budget under $1,000 during ETH Denver.",
      bulletPoints: [
